      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="flex flex-col gap-4">
           ...
           <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="text-lg font-black tracking-tight text-gray-900 dark:text-white">Report</h3>
           </div>
           ...
           <div className="card-glass bg-white dark:bg-[#1e1e1e] p-6 rounded-[11px] border border-gray-100 dark:border-[#222] shadow-sm flex flex-col items-center justify-center h-[500px]">
             ...
             <h4 className="text-sm font-bold text-gray-900 dark:text-white mb-1">No Reports Available</h4>
             <p className="text-gray-500 text-xs text-center max-w-sm">Automated reports will be generated here over time as the system collects more data.</p>
           </div>
        </div>
