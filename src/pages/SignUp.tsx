        ...
        <form className="space-y-6">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input type="text" className="w-full bg-white dark:bg-[#1e1e1e] border border-gray-300 dark:border-[#2a2a2a] rounded-xl py-3 pl-10 pr-4 text-gray-900 dark:text-white focus:ring-2 focus:ring-accent/50 outline-none transition-all" placeholder="John Doe" />
            </div>
          </div>
