  ...
  return (
    <Card className={cn("p-5 flex flex-col group/table h-full", className)}>
      <div className="flex items-center justify-between mb-4 shrink-0">
        ...
        {tabs && (
          <div className="flex gap-4 border-b border-gray-200 dark:border-[#222]">
             {tabs.map((tab, i) => (
               <span 
                 key={tab} 
                 onClick={() => setActiveTab(tab)}
                 className={cn("text-[10px] font-bold tracking-tight cursor-pointer relative pb-1.5 transition-colors", activeTab === tab ? "text-accent" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-300")}
               >
                  {tab}
    ...
    <Card className="p-5 flex flex-col h-full">
       <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
             ...
             <h3 className="text-sm font-bold text-gray-900 dark:text-white tracking-tight leading-none">Event Feed</h3>
          </div>
          <div className="flex gap-4 border-b border-gray-200 dark:border-[#222]">
             <span 
               onClick={() => setActiveTab('Alerts')}
               className={cn("text-[10px] font-bold tracking-tight cursor-pointer relative pb-1.5 transition-colors", activeTab === 'Alerts' ? "text-accent" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-300")}
             >
                Alerts
             ...
             <span 
               ...
               className={cn("text-[10px] font-bold tracking-tight cursor-pointer relative pb-1.5 transition-colors", activeTab === 'Logs' ? "text-accent" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-300")}
             >
                Logs
