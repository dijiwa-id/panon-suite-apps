  ...
  ({ className, variant = 'default', ...props }, ref) => {
    return (
      <button
        ref={ref}
        className={cn(
          "flex items-center justify-center gap-1.5 rounded-full text-xs font-bold tracking-wide transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-[#161616] focus-visible:ring-[#52C5F3] disabled:opacity-50 disabled:pointer-events-none h-8 px-6 leading-[12px]",
          {
            ...
            "border border-gray-200 dark:border-[#333] bg-transparent hover:bg-gray-100 dark:hover:bg-[#252525] text-gray-900 dark:text-gray-100": variant === 'outline',
