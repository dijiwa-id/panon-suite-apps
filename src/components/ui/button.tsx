  ...
  ({ className, variant = 'default', ...props }, ref) => {
    return (
      <button
        ref={ref}
        className={cn(
          "flex items-center justify-center gap-1.5 rounded-lg text-sm font-bold tracking-wide transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-[#161616] focus-visible:ring-[#52C5F3] disabled:opacity-50 disabled:pointer-events-none h-10 px-8 py-2 hover:shadow-md active:scale-[0.98]",
          {
