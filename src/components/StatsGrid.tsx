...
export const StatsGrid = () => {
  ...
  return (
    <div className="card-glass flex flex-col justify-between h-full p-0 shadow-sm border border-gray-200 dark:border-[#1f232d] bg-white dark:bg-[#1e1e1e]">
      {/* Top Stats */}
      <div className="p-5 pb-4">
        <div className="grid grid-cols-4 gap-4 divide-x divide-gray-200 dark:divide-[#1f232d]/60">
          {stats.map((stat, i) => (
            <div key={i} className="flex flex-col items-center justify-center">
              ...
              <p className="text-[9px] text-gray-500 dark:text-[#888] font-bold uppercase tracking-widest text-center">{stat.label}</p>
            </div>
          ))}
        </div>
      </div>

      <div className="mx-5 h-[1px] bg-gray-200 dark:bg-[#1f232d]/60"></div>
      ...
      <div className="p-5 pt-4 flex flex-col justify-between flex-1 gap-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
             ...
             <h3 className="text-[10px] font-bold text-gray-900 dark:text-white uppercase tracking-widest leading-none">Total Detection</h3>
          </div>
        ...
        <div className="flex gap-4 sm:gap-6 items-end">
          <div className="flex flex-col items-start min-w-[70px]">
             <span className="text-[32px] font-bold text-gray-900 dark:text-white leading-none mb-1.5 tracking-tight">123</span>
             <div className="flex items-center gap-1.5 px-2 py-0.5 rounded bg-accent/10 border border-accent/20">
                ...
                <span className="text-gray-500 dark:text-[#888] text-[8px] font-bold uppercase tracking-widest">Vs Yesterday</span>
             </div>
          </div>
          ...
          <div className="flex-1 space-y-2.5 w-full">
            {detections.map((d, i) => (
              <div key={i} className="flex items-center gap-3">
                <span className="text-[9px] font-bold uppercase tracking-widest text-[#666] w-24 truncate">{d.label}</span>
