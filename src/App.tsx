...
const VisualizerHome = lazy(() => import('./pages/3DVisualizer/Home'));
const VisualizerLiveView = lazy(() => import('./pages/3DVisualizer/LiveView'));
const VisualizerDevices = lazy(() => import('./pages/3DVisualizer/Devices'));
const VisualizerRoutines = lazy(() => import('./pages/3DVisualizer/Routines'));
const VisualizerActivity = lazy(() => import('./pages/3DVisualizer/Activity'));
      ...
      <BrowserRouter>
        ...
        <Suspense fallback={<div className="h-screen w-screen flex items-center justify-center dark:bg-[#161616]"><div className="animate-spin rounded-full h-8 w-8 border-b-2 border-accent"></div></div>}>
          <Routes>
                ...
                <Route path="/3d-visualizer/home" element={<VisualizerHome />} />
                <Route path="/3d-visualizer/live-view" element={<VisualizerLiveView />} />
                <Route path="/3d-visualizer/devices" element={<VisualizerDevices />} />
                <Route path="/3d-visualizer/routines" element={<VisualizerRoutines />} />
                <Route path="/3d-visualizer/activity" element={<VisualizerActivity />} />
